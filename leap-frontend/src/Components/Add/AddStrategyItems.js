...
export default class AddStrategyItems extends Component {
    constructor(props) {
        super(props);
        this.state = {
            environments: [],
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Add Strategy Items</li>
                    </ol>
                </nav>
                <div class="jumbotron">
                    <h3>Add Strategy Items</h3>
