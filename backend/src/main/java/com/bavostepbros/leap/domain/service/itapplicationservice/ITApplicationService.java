...
public interface ITApplicationService {
	ITApplication save(Integer statusID, String name, String version, LocalDate purchaseDate,
	...
	ITApplication update(Integer id, Integer statusID, String name, String version,
			LocalDate purchaseDate, LocalDate endOfLife, Integer currentScalability, Integer expectedScalability,
			Integer currentPerformance, Integer expectedPerformance, Integer currentSecurityLevel,
			Integer expectedSecurityLevel, Integer currentStability, Integer expectedStability, String costCurrency,
			String currentValue, Double currentYearlyCost, LocalDate timeValue);
