        ...
        return(
            ...
            <div className="jumbotron">
                ...
                { title: "Date", field: "validityPeriod" },
                {
                    title: '', 
                    name: 'delete',
                    render: rowData => <button className="btn btn-secondary"><i onClick={this.delete.bind(this, rowData.statusId)} className="bi bi-trash"></i></button>
                },
                {
                    title: '', 
                    name: 'edit',
                    render: rowData => <button className="btn btn-secondary"><i onClick={this.edit.bind(this, rowData.statusId)} className="bi bi-pencil"></i></button>
                },
                ]}
